...
```bash
curl -LO https://github.com/uahypersonics/lst_tools-releases/releases/latest/download/lst_tools-1.3.0-py3-none-any.whl
```

## 2. Install the python wheel

```bash
pip install --user lst_tools-1.3.0-py3-none-any.whl
```
